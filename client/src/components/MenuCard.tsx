  ...
  return (
    <Card className="overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-primary/10 bg-black/40 border-primary/20 group">
      ...
      <CardContent className="p-4 relative">
        <h3 className="font-bold text-base md:text-lg mb-2 uppercase tracking-wide text-white group-hover:text-primary transition-colors duration-300">{item.name}</h3>
